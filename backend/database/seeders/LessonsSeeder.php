    ...
    public function run(): void
    {
        ...
        Lesson::create([
            ...
            'exercises' => json_encode([
                ['type' => 'pronunciation', 'words' => ['Caffè', 'Ciao', 'Gelato', 'Gatto', 'Cena']],
                ['type' => 'fill_blank', 'question' => 'La CI si pronuncia [___] davanti a e, i', 'answer' => 'tʃ']
            ]),
        ...
        Lesson::create([
            ...
            'exercises' => json_encode([
                ['type' => 'scenario', 'question' => 'Entrando em padaria de manhã', 'answer' => 'Buongiorno (Lei)'],
                ['type' => 'scenario', 'question' => 'Encontrando amigo para café', 'answer' => 'Ciao (Tu)']
            ]),
        ...
        Lesson::create([
            ...
            'exercises' => json_encode([
                ['type' => 'translate', 'pt' => 'Eu estou feliz (mulher)', 'answer' => 'Io sono felice'],
                ['type' => 'translate', 'pt' => 'Você tem 30 anos?', 'answer' => 'Hai 30 anni?'],
                ['type' => 'translate', 'pt' => 'Nós estamos com pressa', 'answer' => 'Noi abbiamo fretta']
            ]),
            'lesson_type' => 'grammar',
            'difficulty' => 2,
            'estimated_time' => 40,
